...
[travis-image]: https://travis-ci.com/htmlacademy-nodejs/{{userId}}-{{projectName}}.svg?branch=master
[travis-url]: https://travis-ci.com/htmlacademy-nodejs/{{userId}}-{{projectName}}
